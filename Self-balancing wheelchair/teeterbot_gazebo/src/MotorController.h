...
//plugin for motorcontroller, it will reconfigure the motorcontroller parameters by creating a client(inside motorcontroller.cpp) to call the server in order to get the latest values.
